        ...
        Sections = [
            {
                ...
                Tags = ["mechanical ambience"; "distant sub"; "no drums"; "kawaii"]
                Variations = []
            }
            {
                Name = "First Surge"
                Glitches = [Bitcrush; TimeSlip ]
                Kind = Build
                Energy = Extreme
                Vocals = Screaming
                Language = Some Sindarin
                Tags = ["syncopated hats"; "rising noise"; "tension"; "chip tune"]
                Variations = ["add glitch stutters"; "filter sweep"]
            }
            {
                Name = "Main Assault"
                Glitches = [FrameDrop;  PhaseTear]
                Kind = Main
                Energy = Extreme
                Vocals = Whispering
                Language = Some Japanese
                Tags = ["screamed chorus"; "bass growl"; "chip tune"]
            ...
            {           
                ...
                Language = Some Japanese
                Tags = ["bass growl"; "chip tune"; "vocalizer"; "reverb"]
                Variations = ["double-time drums"; "vocal call-and-response"]
            }
            {           
                Name = "First Build"
                ...
                Vocals = AggressiveFemale
                Language = Some Sindarin
                Tags = ["4x4 kick"; "bass growl"; "epic synths"]
                Variations = ["double-time drums"; "vocal call-and-response"]
            }
            {           
                Name = "Second Drop"
                Glitches = [Bitcrush;  DataCorrupt]
                Kind = Drop
                Energy = Extreme
                Vocals = Grunting
                Language = Some Dutch
                Tags = ["electronic"; "bass growl"; "chip tune"]
                Variations = ["double-time drums"; "vocal call-and-response"]
            }
            {           
                Name = "Second Build"
                ...
                Vocals = Barking
                Language = Some Japanese
                Tags = ["4x4 kick"; "electronic"; "bass growl"]
                Variations = ["double-time drums"; "vocal call-and-response"]
            }
            {
                Name = "Big Build"
                ...
                Vocals = Growling
                Language = Some Japanese
                Tags = ["syncopated hats"; "rising noise"; "tension"; "chip tune"; "electronic"]
                Variations = ["add glitch stutters"; "filter sweep"]
            }
            {
                Name = "Big Drop"
                ...
                Vocals = Barking
                Language = Some Sindarin
                Tags = ["bass growl"; "epic vocals"; "chip tune"; "vocalizer"; "reverb"]
                Variations = ["double-time drums"; "vocal call-and-response"]                
            }
            {           
                Name = "Outro"
